 ...
 */
final class Version20230525174923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ephemeride ADD slug VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ephemeride DROP slug');
        ...
        $this->addSql('ALTER TABLE messagerie ADD CONSTRAINT FK_14E8F60C1F8DB0F4 FOREIGN KEY (users_destinataire_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
